...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vendor.approval_status'
        db.alter_column(u'vegancity_vendor', 'approval_status', self.gf('vegancity.fields.StatusField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Vendor.approval_status'
        db.alter_column(u'vegancity_vendor', 'approval_status', self.gf('django.db.models.fields.CharField')(max_length=100))

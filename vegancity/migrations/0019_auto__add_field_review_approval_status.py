...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.approval_status'
        db.add_column(u'vegancity_review', 'approval_status',
                      self.gf('vegancity.fields.StatusField')(default='pending', max_length=100, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.approval_status'
        db.delete_column(u'vegancity_review', 'approval_status')
